...
import static one.genchev.bonbon.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;

import java.time.Instant;
import java.util.*;
import one.genchev.bonbon.IntegrationTest;
import one.genchev.bonbon.config.Constants;
import one.genchev.bonbon.domain.User;
import one.genchev.bonbon.repository.AuthorityRepository;
import one.genchev.bonbon.repository.UserRepository;
import one.genchev.bonbon.security.AuthoritiesConstants;
import one.genchev.bonbon.service.UserService;
import one.genchev.bonbon.service.dto.AdminUserDTO;
import one.genchev.bonbon.service.dto.PasswordChangeDTO;
import one.genchev.bonbon.service.dto.UserDTO;
import one.genchev.bonbon.web.rest.vm.KeyAndPasswordVM;
import one.genchev.bonbon.web.rest.vm.ManagedUserVM;
